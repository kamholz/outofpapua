...
our $dict = {
  ...
  'Visser & Vooehoeve (1987)' => {
    lang_target => 'saj',
    path => 'spreadsheets/wordlist_Sahu_Visser,Voorhoeve1987.xlsx',
    parser => 'Spreadsheet',
    columns => [
      [0, 'headword'],
      [4, 'va', 'split'],
      ...
      [[26 .. 29], 'example', ['ind', 'max', 'eng']],
      [[32 .. 35], 'example', ['ind', 'max', 'eng']],
      [[38 .. 41], 'example', ['ind', 'max', 'eng']],
      [[42 .. 44], 'example', ['ind', 'eng']],
      [[45 .. 47], 'example', ['ind', 'eng']],
      [[48 .. 50], 'example', ['ind', 'eng']],
      [51, 'note'],
      [6, 'page_num'],
    ],
    strip => 'to',
